...
write_csv(all_eval, file.path(OUTPUT_DIR, "evaluation_results.csv"))
cat(sprintf("   Saved: %s\n", file.path(OUTPUT_DIR, "evaluation_results.csv")))

# Per-commodity CSV
write_csv(per_food, file.path(OUTPUT_DIR, "per_food_evaluation.csv"))
cat(sprintf("   Saved: %s\n", file.path(OUTPUT_DIR, "per_food_evaluation.csv")))
